...
xargs -n 1 --max-procs=${N_PROCS_PREPROCESS} --arg-file=/workspace/bert/data/wikipedia_corpus/xarg_list.txt bash /workspace/bert/data/wikipedia_corpus/preprocessing.sh
