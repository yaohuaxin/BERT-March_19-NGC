...
N_PROCS_PREPROCESS=40    # Adjust this based on memory requirements and available number of cores
...
WIKI_DUMP="https://dumps.wikimedia.org/enwiki/latest/enwiki-latest-pages-articles-multistream.xml.bz2"
